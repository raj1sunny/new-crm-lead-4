...
function alertOne(value) {
    console.log('alertOneCall', value)
}
...
async function getTemplate() {
    let response = await fetch(`https://api.wolfeocrm.com/v1/setting/2/template/52`, {
        ...
        headers: {
            ...
            'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJMVENCV1M4RkRVTkdTMDNUIiwiaXNzIjoiaHR0cHM6Ly9hcGkuaWxvZ2dlcnouY29tL2FwaS92MS9sb2dpbiIsImlhdCI6MTY3NzY2Njk1OSwiZXhwIjoxNjc3NjcwNTU5LCJuYmYiOjE2Nzc2NjY5NTksImp0aSI6IkxUQ0JXUzhGRFVOR1MwM1QxNjc3NjY2OTU5In0.Kjz2NpvjF9A3AKhTmN2cqk2CYYWhuECgsnR2_4oEs90'
        }
    }).then(async (res) => {
        data = await res.json();
    })
